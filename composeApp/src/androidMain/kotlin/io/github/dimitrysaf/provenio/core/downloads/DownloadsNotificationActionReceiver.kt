...
class DownloadsNotificationActionReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val actionPause = "io.github.dimitrysaf.provenio.downloads.action.PAUSE"
        const val actionResume = "io.github.dimitrysaf.provenio.downloads.action.RESUME"
