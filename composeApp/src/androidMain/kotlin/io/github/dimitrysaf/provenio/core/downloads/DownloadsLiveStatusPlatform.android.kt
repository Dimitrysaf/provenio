...
import io.github.dimitrysaf.provenio.core.deeplink.buildDownloadsDeepLinkUrl
...
internal actual object DownloadsLiveStatusPlatform {
    ...
    private const val notificationsPrefName = "provenio_download_live_notifications"
    ...
    internal fun buildNotification(context: Context, item: DownloadItem): android.app.Notification {
        ...
        val notificationBuilder = NotificationCompat.Builder(context, channelId)
            .setSmallIcon(io.github.dimitrysaf.provenio.R.drawable.ic_notification_small)
