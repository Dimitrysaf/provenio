...
import io.github.dimitrysaf.provenio.core.concurrent.ConflatedTaskDispatcher
import java.util.concurrent.Executors
import java.util.concurrent.atomic.AtomicBoolean

internal const val NOW_PLAYING_TAG = "ProvenioNowPlaying"
internal const val NOW_PLAYING_CHANNEL_ID = "provenio_playback"
internal const val NOW_PLAYING_NOTIFICATION_ID = 0x4E55
private const val ACTION_START_FOREGROUND = "io.github.dimitrysaf.provenio.nowplaying.START_FOREGROUND"
private const val EXTRA_START_NOTIFICATION = "io.github.dimitrysaf.provenio.nowplaying.START_NOTIFICATION"
...
private object PlayerNowPlayingServiceController {
    private val executor = Executors.newSingleThreadExecutor { runnable ->
        Thread(runnable, "ProvenioNowPlayingService").apply { isDaemon = true }
    }
