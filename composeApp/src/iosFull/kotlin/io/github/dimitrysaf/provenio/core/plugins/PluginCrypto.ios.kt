...
import io.github.dimitrysaf.provenio.core.plugins.cryptointerop.*
...
internal fun pluginAesEncrypt(
    ...
    if (isGcm) {
        ...
        memScoped {
            val cryptorRefVar = alloc<io.github.dimitrysaf.provenio.core.plugins.cryptointerop.CCCryptorRefVar>()
