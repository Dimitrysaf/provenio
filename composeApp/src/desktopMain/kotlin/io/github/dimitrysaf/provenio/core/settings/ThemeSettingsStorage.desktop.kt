...
actual object ThemeSettingsStorage {
    ...
    actual fun applySelectedAppLanguage(languageCode: String) {
        // The desktop JVM has one locale for the process; Compose resources follow it.
        Locale.setDefault(
            if (languageCode.equals("device", ignoreCase = true)) systemLocale else Locale.forLanguageTag(languageCode),
        )
    }
