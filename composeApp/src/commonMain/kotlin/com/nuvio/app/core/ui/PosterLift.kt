 ...
 * callback fires. The start frame of the lift that carries the poster into the details screen.
 */
...
internal fun Modifier.posterCardClickable(
    ...
    return posterModifier
        .combinedClickable(
            ...
            // A long press opens a sheet, which needs no anchor: nothing flies out of the card.
