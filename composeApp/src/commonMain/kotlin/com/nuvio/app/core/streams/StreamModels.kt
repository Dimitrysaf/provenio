...
data class AddonStreamGroup(
    ...
    /**
     * The add-on's own icon, carried on the group rather than read off its first stream: the
     * group's row exists from the moment the fetch starts, which is before there is a stream to
     * take it from.
     */
    val addonLogo: String? = null,
)
