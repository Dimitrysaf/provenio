...
import com.nuvio.app.features.streams.StreamRow
            ...
            LazyColumn(
                ...
                itemsIndexed(
                    ...
                    StreamRow(
                        ...
                        // A torrent plays through a local engine URL that matches nothing in the
                        // list, so the stream's own identity settles it when the URL cannot.
                        selected = ActiveStreamStore.isActive(stream) ||
                            stream.isCurrentPlayerStream(currentStreamUrl, currentStreamName),
