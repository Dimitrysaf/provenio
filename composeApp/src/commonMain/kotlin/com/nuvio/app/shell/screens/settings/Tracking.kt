...
import com.nuvio.app.core.tracking.TrackingSettingsUiState
import com.nuvio.app.core.tracking.WatchProgressSource
import com.nuvio.app.core.tracking.effectiveLibrarySourceMode
...
import com.nuvio.app.core.tracking.trakt.TRAKT_CONTINUE_WATCHING_DAYS_CAP_ALL
import com.nuvio.app.core.tracking.trakt.TraktAuthUiState
import com.nuvio.app.core.tracking.trakt.TraktConnectionMode
import com.nuvio.app.core.tracking.trakt.TraktContinueWatchingDaysOptions
import com.nuvio.app.core.tracking.trakt.normalizeTraktContinueWatchingDaysCap
    ...
    navigationRow(
        ...
        trailingContent = {
            Row(
                ...
                if (isLoading) {
                    NuvioLoadingIndicator(size = 16.dp)
                }
                Text(
                    text = value,
