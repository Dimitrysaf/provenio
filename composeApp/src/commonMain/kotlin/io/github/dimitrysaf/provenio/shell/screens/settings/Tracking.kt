...
import io.github.dimitrysaf.provenio.core.tracking.effectiveLibrarySourceMode
...
import io.github.dimitrysaf.provenio.core.tracking.trakt.TRAKT_CONTINUE_WATCHING_DAYS_CAP_ALL
...
import io.github.dimitrysaf.provenio.core.tracking.trakt.TraktContinueWatchingDaysOptions
import io.github.dimitrysaf.provenio.core.tracking.trakt.normalizeTraktContinueWatchingDaysCap
...
import provenio.composeapp.generated.resources.settings_tracking_connect_first
import provenio.composeapp.generated.resources.settings_tracking_data_sources
...
import provenio.composeapp.generated.resources.settings_tracking_tmdb_recommendations_description
import provenio.composeapp.generated.resources.settings_tracking_trakt_library_description
...
import provenio.composeapp.generated.resources.settings_tracking_anime_id_imdb_description
import provenio.composeapp.generated.resources.settings_tracking_anime_id_kitsu
import provenio.composeapp.generated.resources.settings_tracking_anime_id_kitsu_description
import provenio.composeapp.generated.resources.settings_tracking_anime_id_tvdb
import provenio.composeapp.generated.resources.settings_tracking_anime_id_tvdb_description
import provenio.composeapp.generated.resources.settings_tracking_anime_id_mal
...
import provenio.composeapp.generated.resources.tracking_watch_progress_dialog_subtitle
import provenio.composeapp.generated.resources.trakt_all_history
import provenio.composeapp.generated.resources.trakt_continue_watching_subtitle
import provenio.composeapp.generated.resources.trakt_continue_watching_window
import provenio.composeapp.generated.resources.trakt_cw_window_subtitle
import provenio.composeapp.generated.resources.trakt_cw_window_title
import provenio.composeapp.generated.resources.trakt_days_format
import provenio.composeapp.generated.resources.trakt_library_source_dialog_subtitle
import provenio.composeapp.generated.resources.trakt_library_source_dialog_title
import provenio.composeapp.generated.resources.trakt_library_source_account
import provenio.composeapp.generated.resources.trakt_library_source_subtitle
import provenio.composeapp.generated.resources.trakt_library_source_title
import provenio.composeapp.generated.resources.trakt_library_source_trakt
import provenio.composeapp.generated.resources.trakt_more_like_this_source_dialog_subtitle
import provenio.composeapp.generated.resources.trakt_more_like_this_source_dialog_title
import provenio.composeapp.generated.resources.trakt_more_like_this_source_subtitle
import provenio.composeapp.generated.resources.trakt_more_like_this_source_title
import provenio.composeapp.generated.resources.trakt_more_like_this_source_tmdb
import provenio.composeapp.generated.resources.trakt_more_like_this_source_trakt
import provenio.composeapp.generated.resources.trakt_watch_progress_dialog_title
import provenio.composeapp.generated.resources.trakt_watch_progress_source_account
import provenio.composeapp.generated.resources.trakt_watch_progress_source_trakt
import provenio.composeapp.generated.resources.trakt_watch_progress_subtitle
import provenio.composeapp.generated.resources.trakt_watch_progress_title
import org.jetbrains.compose.resources.stringResource
import io.github.dimitrysaf.provenio.core.settings.TrackingBrand
import io.github.dimitrysaf.provenio.core.settings.effectiveTrackingRecommendationsSource
import io.github.dimitrysaf.provenio.core.settings.isTrackingBrandAvailable
...
/**
 * A refresh that failed, and the offer to try again.
 *
 * It paints its own container so it segments with the rows above it: declared as a plain
 * composable it would compose outside the list's column and sit beside the group instead.
 */
// Declares rows, so it must not be skippable: see SettingsListScope.
@Composable
@NonRestartableComposable
private fun SettingsListScope.TrackingInlineErrorRow(
    message: String,
    onRetry: () -> Unit,
) = shapedRow { shape ->
    Surface(
...
private fun librarySourceOptions(
    ...
    return listOf(
        TrackingPickerOption(
            ...
            title = stringResource(Res.string.trakt_library_source_account),
            description = stringResource(Res.string.settings_tracking_account_library_description),
        ),
        TrackingPickerOption(
...
private fun watchProgressSourceOptions(
    ...
    return listOf(
        TrackingPickerOption(
            value = WatchProgressSource.ACCOUNT_SYNC,
            title = stringResource(Res.string.trakt_watch_progress_source_account),
            description = stringResource(Res.string.settings_tracking_account_progress_description),
        ),
        TrackingPickerOption(
...
private fun librarySourceModeLabel(source: LibrarySourceMode): String = when (source) {
    ...
    LibrarySourceMode.LOCAL -> stringResource(Res.string.trakt_library_source_account)
...
private fun watchProgressSourceLabel(source: WatchProgressSource): String = when (source) {
    ...
    WatchProgressSource.ACCOUNT_SYNC -> stringResource(Res.string.trakt_watch_progress_source_account)
