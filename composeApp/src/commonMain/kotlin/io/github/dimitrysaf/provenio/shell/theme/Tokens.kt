...
internal val LocalThemeTokens = staticCompositionLocalOf {
    defaultThemeTokens(ThemeColors.White, amoled = false, colorScheme = null)
}

val MaterialTheme.provenio: ThemeTokens
    @Composable
    @Stable
    get() = LocalThemeTokens.current

internal fun defaultThemeTokens(
    ...
    return ThemeTokens(
        ...
        spacing = SpacingTokens(
            ...
            railGap = Tokens.Space.s14,
            cardPadding = Tokens.Space.s18,
            controlGap = Tokens.Space.s8,
            dialogPadding = Tokens.Space.s20,
        ),
        shapes = ShapeTokens(
            card = RoundedCornerShape(Tokens.Radius.card),
            compactCard = RoundedCornerShape(Tokens.Radius.compactCard),
            sheet = RoundedCornerShape(Tokens.Radius.sheet),
            dialog = RoundedCornerShape(Tokens.Radius.dialog),
            button = RoundedCornerShape(Tokens.Radius.button),
            chip = RoundedCornerShape(Tokens.Radius.chip),
            poster = RoundedCornerShape(Tokens.Radius.poster),
            avatar = RoundedCornerShape(Tokens.Radius.avatar),
            playerPanel = RoundedCornerShape(Tokens.Radius.playerPanel),
        ),
        ...
        opacity = OpacityTokens(
            ...
            secondary = Tokens.Opacity.secondary,
            muted = Tokens.Opacity.muted,
            selected = Tokens.Opacity.selected,
            pressed = Tokens.Opacity.pressed,
            subtle = Tokens.Opacity.subtle,
            medium = Tokens.Opacity.medium,
            strong = Tokens.Opacity.strong,
            visible = Tokens.Opacity.visible,
        ),
        icons = IconTokens(
            sm = Tokens.Icon.sm,
            md = Tokens.Icon.md,
