...
import io.github.dimitrysaf.provenio.core.watch.progress.isMalformedNextUpSeedContentId
...
import io.github.dimitrysaf.provenio.core.cloud.findPlaybackTargetForProgress
import io.github.dimitrysaf.provenio.core.watch.progress.CachedInProgressItem
...
import io.github.dimitrysaf.provenio.core.watch.progress.buildContinueWatchingEpisodeSubtitle
...
internal fun cachedNextUpHasAired(
    ...
    releaseEpochMs: Long? = io.github.dimitrysaf.provenio.core.watch.progress.parseReleaseDateToEpochMs(cached.released),
): Boolean =
...
internal fun CachedNextUpItem.toContinueWatchingItem(
    ...
    val alertState = io.github.dimitrysaf.provenio.core.watch.progress.calculateReleaseAlertState(
