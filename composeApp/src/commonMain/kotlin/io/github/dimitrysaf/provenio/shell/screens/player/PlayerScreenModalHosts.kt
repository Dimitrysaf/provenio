...
import io.github.dimitrysaf.provenio.core.metadata.MetaDetailsUiState
...
internal fun PlayerScreenModalHosts(
    ...
    if (showSubmitIntroModal && season != null && episode != null && !imdbId.isNullOrBlank()) {
        io.github.dimitrysaf.provenio.shell.screens.player.skip.SubmitIntroDialog(
            imdbId = imdbId,
            season = season,
            episode = episode,
...
internal fun selectDownloadedEpisodeForPlayback(
    parentMetaId: String,
    episode: MetaVideo,
    onDownloadedEpisodeSelected: (io.github.dimitrysaf.provenio.core.downloads.DownloadItem, MetaVideo) -> Unit,
): Boolean {
