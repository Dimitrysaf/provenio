package io.github.dimitrysaf.provenio.core.cloud

import io.github.dimitrysaf.provenio.core.debrid.DebridProviders
import io.github.dimitrysaf.provenio.core.debrid.TorboxApiClient
import io.github.dimitrysaf.provenio.core.debrid.TorboxCloudFileDto
import io.github.dimitrysaf.provenio.core.debrid.TorboxCloudItemDto
...
internal class TorboxCloudLibraryProviderApi : CloudLibraryProviderApi {
    ...
    private fun io.github.dimitrysaf.provenio.core.debrid.DebridApiResponse<io.github.dimitrysaf.provenio.core.debrid.TorboxEnvelopeDto<List<TorboxCloudItemDto>>>.itemsOrThrow(
...
internal fun io.github.dimitrysaf.provenio.core.debrid.DebridApiResponse<io.github.dimitrysaf.provenio.core.debrid.TorboxEnvelopeDto<List<TorboxCloudItemDto>>>.toCloudLibraryItemsOrThrow(
    providerId: String,
    providerName: String,
    type: CloudLibraryItemType,
): List<CloudLibraryItem> {
