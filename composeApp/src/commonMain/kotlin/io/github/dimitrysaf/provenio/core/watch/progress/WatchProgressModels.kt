...
import io.github.dimitrysaf.provenio.core.cloud.cloudLibraryProviderPosterUrl
import io.github.dimitrysaf.provenio.core.metadata.MetaVideo
import io.github.dimitrysaf.provenio.core.tracking.TrackingAttributedItem
...
import io.github.dimitrysaf.provenio.core.tracking.TrackingProgressSnapshot
...
data class WatchProgressUiState(
    val source: WatchProgressSource = WatchProgressSource.ACCOUNT_SYNC,
...
): String = io.github.dimitrysaf.provenio.core.watch.watching.domain.buildPlaybackVideoId(
...
internal fun projectWatchProgressUiState(
    ...
    hasLoadedAccountRemoteProgress: Boolean,
    ...
    hasLoadedRemoteProgress =
        providerSnapshot?.hasLoadedRemoteProgress ?: hasLoadedAccountRemoteProgress,
)
