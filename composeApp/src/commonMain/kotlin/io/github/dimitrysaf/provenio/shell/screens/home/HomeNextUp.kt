...
import io.github.dimitrysaf.provenio.core.watch.watched.episodePlaybackId
...
import io.github.dimitrysaf.provenio.core.watch.progress.shouldTreatAsInProgressForContinueWatching
...
import io.github.dimitrysaf.provenio.core.watch.progress.toUpNextContinueWatchingItem
import kotlinx.coroutines.CancellationException
import io.github.dimitrysaf.provenio.core.home.HomeContinueWatchingMaxRecentProgressItems
import io.github.dimitrysaf.provenio.core.home.hasUsableHomeNextUpMetadata
import io.github.dimitrysaf.provenio.core.home.mergeHomeNextUpItemsWithCache
import io.github.dimitrysaf.provenio.core.home.planHomeNextUpResolutionCandidates
...
import io.github.dimitrysaf.provenio.core.home.HomeNextUpCandidateMetadataOutcome
import io.github.dimitrysaf.provenio.core.home.classifyHomeNextUpCandidateMetadata
...
internal suspend fun resolveHomeNextUpCandidate(
    ...
    val sortTimestamp = if (item.isReleaseAlert) {
        io.github.dimitrysaf.provenio.core.watch.progress.parseReleaseDateToEpochMs(item.released) ?: completedEntry.markedAtEpochMs
    } else {
...
internal fun MetaDetails.videoForSeriesAction(action: SeriesPrimaryAction): MetaVideo? {
    ...
    return videos.firstOrNull { video ->
        io.github.dimitrysaf.provenio.core.watch.progress.buildPlaybackVideoId(
            parentMetaId = id,
