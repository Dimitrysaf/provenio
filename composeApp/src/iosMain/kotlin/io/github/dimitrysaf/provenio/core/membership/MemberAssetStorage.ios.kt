...
internal actual object MemberAssetStorage {
    ...
    private val backgroundDirectory = "${NSHomeDirectory()}/Library/Caches/ProvenioMemberBackgrounds"
    private val avatarDirectory = "${NSHomeDirectory()}/Library/Caches/ProvenioMemberAvatars"
    private val legacyBrandingPath = "${NSHomeDirectory()}/Library/Application Support/ProvenioMembership/branding.png"
