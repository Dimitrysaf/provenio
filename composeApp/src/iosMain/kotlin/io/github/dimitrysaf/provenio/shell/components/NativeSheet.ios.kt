...
internal actual val usesNativeBottomSheet: Boolean = true

private var activeNativeBottomSheet: UIViewController? = null

private var activeNativeBottomSheetDelegate: NativeBottomSheetDelegate? = null
...
internal actual fun NativeModalSheet(
    ...
    DisposableEffect(parentViewController) {
        ...
        val dismissalDelegate = NativeBottomSheetDelegate {
...
internal actual fun dismissNativeBottomSheet() {
    activeNativeBottomSheet?.dismissViewControllerAnimated(
        flag = true,
        completion = null,
    )
...
private class NativeBottomSheetDelegate(
