...
private let lockPlayerToLandscapeNotification = Notification.Name("ProvenioPlayerLockLandscape")
private let unlockPlayerOrientationNotification = Notification.Name("ProvenioPlayerUnlockOrientation")
