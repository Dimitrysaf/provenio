...
Engine is a cross-platform torrent streaming engine.
...
Built in C++20 and powered by libtorrent, Engine provides a shared native core for torrent playback, including playback-aware piece scheduling, file selection, caching, and local HTTP range streaming.
